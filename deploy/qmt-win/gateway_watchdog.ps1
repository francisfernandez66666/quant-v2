...
while ($true) {
    ...
    # 允许来源 IP 白名单。
    #   - 过渡期（首尔仍连接校验）：保留首尔出口 IP 43.108.86.140 + 本机 127.0.0.1
    #   - 全合一切流后（docs/MIGRATION_GUANGZHOU_ALLINONE.md §3.5）：改为仅 127.0.0.1，
    #     不再对公网暴露 8789（quant→gateway 走 localhost）；同时收严腾讯云防火墙 8789 来源。
